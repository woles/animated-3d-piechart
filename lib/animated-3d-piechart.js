...
Donut3D.update = function (id, _data, userConfig) {
  ...
  Donut3D.draw(id, _data, userConfig);
};

Donut3D.draw = function (chartId, _data, userConfig) {
  var conf = {
    h: 20,
    ir: 0,
    fontSize: 12,
  ...
  Donut3D.data = Object.assign([], _data);
